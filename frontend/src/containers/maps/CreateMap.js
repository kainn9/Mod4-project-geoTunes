...
import { UserPlaylists, SpotifyApiContext } from 'react-spotify-api';
...
const CreateMap = (props) => {
  ...
  return (
    <div>
      ...
      <Nav user={props.user} createMode logOutHandler={props.logOutHandler} createPath={createPath} />
          ...
          <UserPlaylists>
            {
                            (playlists, loading, error) => {
                              ...
                              if (playlists.data) {
                                ...
                                plOptions = playlists.data.items.map((pl, i) => ({ key: i, value: pl.uri, text: pl.name }));
                              }
